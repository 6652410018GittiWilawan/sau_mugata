...
import 'package:sau_mugata/views/show_bill_ui.dart';
                  ...
                  children: [
                    Expanded(
                      ...
                      onPressed: () {
                        ...
                        if(imgFile == null){
                          //แจ้งเตื้อน
                        }else if(adultCheck == true && adultCtrl.text == '0' || adultCtrl.text.length == 0 ){
                          //แจ้งเตือน
                        }else if(childCheck == true && adultCtrl.text == '0' || adultCtrl.text.length ==0 ){
                          //แจ้งเตือน
                        }else{
                          //พร้อมคำ
                          ...
                          double payWaterBuffet = waterCheck == 1 ? 25.0 * (adult + child) : 0;
                          double payTotal = (299.0 * adult) + (69.0 * child) + (20.0 * coke) + (15.0 * pure) + payWaterBuffet;
                          payTotal = payTotal - (payTotal * discount);
                          Navigator.push(
                            context,MaterialPageRoute(builder:(context) => ShowBillUi(
                              payTotal: payTotal,
                              imgFile: imgFile,
                            ))
                          )
